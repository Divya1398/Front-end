...
function Addblog() {
    ...
    const addblog=async(e)=>{
      e.preventDefault()
     const res = await axios.post("http://localhost:5000/blogs",form)
  ...
  return (
    <div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-12 wow fadeInUp" data-wow-delay="0.4s">
                  ...
                  <div className="col-lg-12 col-xl-6">
                    <div className="form-floating">
                      <input
                        ...
                        onChange={handlechange}
                      />
                      <label htmlFor="phone">Your Date</label>
                    </div>
                  </div>
                   <div className="col-lg-12">
                    <div className="form-floating">
                      ...
                      <label htmlFor="email">Your Event</label>
                    </div>
                  </div>
                  <div className="col-12">
                    <div className="form-floating">
                      <input
                        ...
                        onChange={handlechange}
                      />
                      <label htmlFor="subject">Your Images</label>
                    </div>
                  </div>
                  <div className="col-12">
                    <div className="form-floating">
